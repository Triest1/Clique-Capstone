...
const About = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      description: 'Championing women\'s rights and community development initiatives.'
    },
    {
      name: 'Hon. Pedro Reyes',
      position: 'Barangay Councilor',
      image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face',
      description: 'Focused on infrastructure and public works improvement.'
    }
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              About Barangay San Jose
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto mb-8">
              Serving our community with dedication, integrity, and commitment to excellence since 1998
            </p>
            <Link 
              to="/contact" 
              ...
              <div className="space-y-4 text-gray-600">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p>Barangay San Jose was officially established as a separate administrative unit.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-3 h-3 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">Barangay Hall, San Jose Street<br />City of Manila, Philippines</p>
              <Link 
                to="/contact" 
            ...
            >
              ...
              <p className="text-gray-600 mb-4">info@barangaysanjose.gov.ph<br />We'll respond within 24 hours</p>
              <a 
                href="mailto:info@barangaysanjose.gov.ph" 
                className="text-blue-600 hover:text-blue-700 font-medium"
              >
                Send Email →
              </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Together, we can create a more vibrant, inclusive, and sustainable Barangay San Jose for all our residents.
            </p>
