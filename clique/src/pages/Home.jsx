...
const Home = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Quick and efficient processing of barangay documents"
    }
  ]
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="flex items-center justify-center mb-6">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Important Announcements</h2>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Barangay San Jose by the Numbers
            </h2>
