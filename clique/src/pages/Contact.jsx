            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Barangay Hall, San Jose Street<br />
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Main Office: (02) 8-123-4567<br />
                    Emergency: (02) 8-123-4568<br />
                    Fax: (02) 8-123-4569
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    General: info@barangaysanjose.gov.ph<br />
                    Complaints: complaints@barangaysanjose.gov.ph<br />
                    Support: support@barangaysanjose.gov.ph
                  </p>
                </div>
              </div>
