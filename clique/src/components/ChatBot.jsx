...
const ChatBot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'bot',
      content: 'Hello! I\'m your Barangay AI Assistant. I can help you with various barangay documents like clearance, residency certificates, indigency certificates, and more. How can I assist you today?',
      timestamp: new Date()
    }
  ])
  ...
  const essentialQueries = {
    'greeting': {
      ...
      response: 'Hello! Welcome to the Barangay AI Assistant. I\'m here to help you with information about our barangay services, including:\n\n• Barangay Clearance\n• Indigency Certificates\n• Business Permits\n• Office Hours\n• Event Information\n• And much more!\n\nHow can I assist you today?',
      category: 'greeting'
    },
    'help': {
      keywords: ['help', 'what can you do', 'what do you do', 'assist', 'guide'],
      response: 'I can assist you with several barangay documents and services:\n• Barangay Clearance\n• Certificate of Residency\n• Indigency Certificate\n• Community Tax Certificate\n• Barangay Business Permit\n• Office Hours and Location\n• Event Information\n\nWhich document or service do you need help with?',
      category: 'general_info'
    },
    'office_hours': {
      keywords: ['office hours', 'hours', 'open', 'close', 'time', 'schedule'],
      response: 'Our barangay office is open Monday to Friday, 8:00 AM to 5:00 PM. We\'re closed on weekends and holidays. For urgent matters, you can contact our emergency hotline.',
      category: 'general_info'
    },
    'location': {
      keywords: ['location', 'address', 'where', 'place', 'office'],
      response: 'Our barangay office is located at Barangay Hall, San Jose Street, City of Manila, Philippines. We\'re near the main plaza and easily accessible by public transportation.',
      category: 'general_info'
    }
  }
                ...
                <div className="flex items-center space-x-3 flex-1 min-w-0">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="font-semibold text-sm sm:text-base truncate">
                      {isStaffChat ? 'Live Staff Support' : 'Barangay AI Assistant'}
                    </h3>
